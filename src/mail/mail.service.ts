...
export class MailService {
  ...
  // ─── Sujets OTP multilingues ──────────────────────────────────────────────
  private getOtpSubject(language: string): string {
    const subjects = {
  ...
  // ─── Template OTP HTML ────────────────────────────────────────────────────
  private buildOtpTemplate(code: string, language: string): string {
    const texts = {
      fr: {
...
<body style="margin:0;padding:0;background:#F2F4F7;font-family:'Helvetica Neue',Arial,sans-serif;">
  ...
  // ─── Template Bienvenue ───────────────────────────────────────────────────
  private buildWelcomeTemplate(firstName: string, language: string): string {
    return `
<!DOCTYPE html>
<html lang="${language}">
...
<body style="margin:0;padding:0;background:#F2F4F7;font-family:'Helvetica Neue',Arial,sans-serif;">
  ...
  // ─── Template Chauffeur approuvé ──────────────────────────────────────────
  private buildDriverApprovedTemplate(firstName: string): string {
    return `
<!DOCTYPE html>
<html lang="fr">
<head><meta charset="UTF-8"/></head>
